...
export default function Hero() {
  return (
    <section 
      id="home" 
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-skyled-navy text-white"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 leading-tight">
            Skyled Pro <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-skyled-light via-white to-skyled-light">
              Indonesia
            </span>
          </h1>
